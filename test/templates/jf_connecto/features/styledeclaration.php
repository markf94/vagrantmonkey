...
class GantryFeatureStyleDeclaration extends GantryFeature {
	...
	// START VARIABLES - JF JOOMLA CUSTOM STYLE ///////////////////////////////////////////////////////////////////////////////////////
		$jf_custom_style_lessVariables = array (
			'jf_colors_bg'    					=> $gantry->get('jf_colors_bg',					'#ffffff'),
			'jf_colors_header'    				=> $gantry->get('jf_colors_header',				'#37AFCD'),
			'jf_colors_slideshow'    			=> $gantry->get('jf_colors_slideshow',			'#37AFCD'),
			'jf_colors_breadcrumb'    			=> $gantry->get('jf_colors_breadcrumb',			'#F8F8F8'),
			'jf_colors_breadcrumb_border'    	=> $gantry->get('jf_colors_breadcrumb_border',	'#eeeeee'),
			
			'jf_colors_footer_bg'    			=> $gantry->get('jf_colors_footer_bg',			'#ffffff'),
			'jf_colors_footer_text'    			=> $gantry->get('jf_colors_footer_text',		'#555555'),
			'jf_colors_footer_link'    			=> $gantry->get('jf_colors_footer_link',		'#37AFCD'),
			'jf_colors_main'    				=> $gantry->get('jf_colors_main',   			'#37AFCD')
		);
		$gantry->addLess('jf_custom_style.less', 'jf_custom_style.css', 8, $jf_custom_style_lessVariables);
	// START VARIABLES - JF EASYBLOG CUSTOM STYLE ///////////////////////////////////////////////////////////////////////////////////////
		if ($gantry->get('jf_eb_colors_override')) {
			$jf_custom_eb_style_lessVariables = array (
				'jf_eb_UC_MainColor'  			=> $gantry->get('jf_eb_UC_MainColor',				'#37AFCD'),
				'jf_eb_UC_ToolbarTopGR'  		=> $gantry->get('jf_eb_UC_ToolbarTopGR',			'#37AFCD'),
				'jf_eb_UC_ToolbarBottomGR'  	=> $gantry->get('jf_eb_UC_ToolbarBottomGR',			'#37AFCD')
			);
			$gantry->addLess('jf_custom_easyblog_style.less', 'jf_custom_easyblog_style.css', 8, $jf_custom_eb_style_lessVariables);
		}
	//   END VARIABLES - JF EASYBLOG CUSTOM STYLE ///////////////////////////////////////////////////////////////////////////////////////

	// START VARIABLES - JF EASYSOCIAL CUSTOM STYLE ///////////////////////////////////////////////////////////////////////////////////////
		if ($gantry->get('jf_es_colors_override')) {
			$jf_custom_es_style_lessVariables = array (
				'jf_es_UC_MainColor'  			=> $gantry->get('jf_es_UC_MainColor',				'#37AFCD'),
				'jf_es_UC_ToolbarTopGR'  		=> $gantry->get('jf_es_UC_ToolbarTopGR',			'#37AFCD'),
				'jf_es_UC_ToolbarBottomGR'  	=> $gantry->get('jf_es_UC_ToolbarBottomGR',			'#37AFCD'),
				'jf_es_UC_ButtonRed'  			=> $gantry->get('jf_es_UC_ButtonRed',				'#dd0000'),
				'jf_es_UC_ButtonGreen'  		=> $gantry->get('jf_es_UC_ButtonGreen',				'#00B856')
			);
			$gantry->addLess('jf_custom_easysocial_style.less', 'jf_custom_easysocial_style.css', 8, $jf_custom_es_style_lessVariables);
		}
	//   END VARIABLES - JF EASYSOCIAL CUSTOM STYLE ///////////////////////////////////////////////////////////////////////////////////////

	// START VARIABLES - JF COMMUNITY BUILDER CUSTOM STYLE ///////////////////////////////////////////////////////////////////////////////////////
		if ($gantry->get('jf_cb_colors_override')) {
			$jf_custom_cb_style_lessVariables = array (
				'jf_cb_UC_MainColor'  			=> $gantry->get('jf_cb_UC_MainColor',				'#37AFCD'),
				'jf_cb_UC_MenubarColor'  		=> $gantry->get('jf_cb_UC_MenubarColor',			'#37AFCD'),
				'jf_cb_UC_TemplateBody'  		=> $gantry->get('jf_cb_UC_TemplateBody',			'#ffffff')
			);
			$gantry->addLess('jf_custom_cb_style.less', 'jf_custom_cb_style.css', 8, $jf_custom_cb_style_lessVariables);
		}
	//   END VARIABLES - JF COMMUNITY BUILDER CUSTOM STYLE ///////////////////////////////////////////////////////////////////////////////////////
