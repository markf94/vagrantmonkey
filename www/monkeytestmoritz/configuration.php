...
class JConfig {
	...
	public $sitename = 'monkeytestmoritz';            // Name of Joomla site
	...
	public $db = 'sites_monkeytestmoritz';                         // DB database name
	public $dbprefix = 'j_';               // Do not change unless you need to!

	/* Server Settings */
	public $secret = 'VwIvIL52owMZ8VG6';     // Change this to something more secure
	public $gzip = '0';
	...
	public $ftp_root = '';
	public $ftp_enable = '';
	public $tmp_path = '/var/www/monkeytestmoritz/tmp/';                // Please check with your host that this is the correct path to the temp directory. This path needs to be writable by Joomla!
	public $log_path = '/var/www/monkeytestmoritz/logs/';           // Please check with your host that this is the correct path to the logs directory. This path needs to be writable by Joomla!
