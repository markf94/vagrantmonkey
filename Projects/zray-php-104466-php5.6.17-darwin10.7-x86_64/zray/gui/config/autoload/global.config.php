...
return array(
	...
	'profiles' => array(
	    ...
	    // note: 'zend_monitor.event_generate_trace_file' => 0, 'zend_codetracing.buffer_size' => '10M' in both production/development. but still it has other value, so we set it anyway. bug #ZSRV-15027
		'productionDirectives'=>array(
			'ZEND' 		=> array('zend_codetracing.max_disk_space' => '1000', 'zend_debugger.allow_hosts'=>'127.0.0.0/8', 'zend.monitor_generate_unique_events' => '0', 'zray.enable' => '0', 'zend_jobqueue.validate_ssl' => '1', 'zend_deployment.validate_ssl' => '1', 'zend_monitor.event_generate_trace_file' => 0, 'zend_codetracing.buffer_size' => '10M'),
			'GUI' 		=> array('serverProfile'=>'Production'),
		...
		'developmentDirectives'=>array(
				'ZEND' 		=> array('zend_codetracing.max_disk_space' => '500', 'zend_debugger.allow_hosts'=>'127.0.0.0/8,10.0.0.0/8,192.168.0.0/16,172.16.0.0/12',  'zend.monitor_generate_unique_events'=>'1', 'zray.enable' => '1', 'zend_jobqueue.validate_ssl' => '0', 'zend_deployment.validate_ssl' => '0', 'zend_monitor.event_generate_trace_file' => 0, 'zend_codetracing.buffer_size' => '10M'),
